...
export const PROVIDER_BUTTON_STYLES: Record<
  AuthProviderId,
...
> = {
  ...
  github: {
    button: "bg-[#24292f] text-white hover:bg-[#24292f]/90 border border-transparent",
    icon: "size-5",
  },
  facebook: {
    button:
      "bg-[#1877F2] text-white hover:bg-[#1877F2]/90 border border-transparent",
    icon: "size-5",
  },
};
